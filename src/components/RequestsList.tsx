        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className={`flex items-center justify-center p-2 rounded-xl transition-all cursor-pointer active:scale-95 ${filtersVisible ? 'bg-amber-100 text-amber-800' : 'bg-slate-100 hover:bg-slate-200 text-slate-700'}`}
